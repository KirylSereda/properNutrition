...
function calc() {
    ...
    function iniLocalstorage(selector, activeClass) {
    ...
    iniLocalstorage('#gender div', 'calculating__choose-item_active');
    iniLocalstorage('.calculating__choose_big div ', 'calculating__choose-item_active');
        ...
        elemets.forEach(elem => {
            elem.addEventListener('click', (e) => {
                if (e.target.getAttribute('data-ratio')) {
                    ...
                    localStorage.setItem('ratio', ration);
                } else {
...
function forms ( formSelector, ModalTimerId) {
    ...
    function showThanksModal(message) {
        ...
        setTimeout(() => {
            ...
            (0,_modal__WEBPACK_IMPORTED_MODULE_0__.modalExit)('.modal');
        }, 4000);
    }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "modalExit": () => (/* binding */ modalExit),
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const ModalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.modalOpen)('.modal', ModalTimerId), 2000);

    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item','.tabcontent','.tabheader__items','tabheader__item_active')
    ;(0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modul]', '.modal', ModalTimerId)
    ;(0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('2022-06-12')
